...
If a TPO updates their company profile or team (e.g. `tpo.name`, `tpo.team`, `tpo.dbas` etc.) updates will be bundled into a single `application_updated` event sent within an hour.
